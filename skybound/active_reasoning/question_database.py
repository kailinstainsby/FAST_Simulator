"""Question bank for the Active Reasoning Challenges.

Each entry is a list of six strings:
    [question_text, context_or_hint, correct_answer, wrong_1, wrong_2, wrong_3]

The correct answer is always at index 2.  The game shuffles answer order
before presenting the options to the user.
"""
...
TOTAL_QUESTIONS = len(QUESTIONS)  # 203

# Convenience accessors for a question entry
QUESTION_TEXT = 0
QUESTION_CONTEXT = 1
CORRECT_ANSWER = 2
WRONG_ANSWER_1 = 3
